...
const perguntas = [
    ...
    {
        enunciado: "Você acha que ao ensino à distância é uma alternativa eficaz ao ensino presencial?",
        alternativas: [
            {
                texto: "A favor",
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "Concordo",
                afirmacao: "Envolver os alunos na criação do currículo escolar promove habilidades de liderança, tomada de decisão e responsabilidade, importantes para seu desenvolvimento pessoal e profissional."
            },
            {
                texto: "Discordo",
                afirmacao: "Um currículo escolar definido majoritariamente pelos alunos pode levar à inconsistência na qualidade e no conteúdo da educação, comprometendo a formação acadêmica básica que é necessária para todos."
            }
        ]
    },
];
